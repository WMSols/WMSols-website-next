  ...
  return (
    <>
      <section className="relative min-h-[60vh] flex items-center overflow-hidden gradient-hero">
        ...
        <div className="absolute bottom-1/4 left-1/5 w-64 h-64 bg-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
            ...
            <div>
              ...
              >
                ...
                <div className="flex items-center gap-3 text-primary-foreground/60">
                  ...
                  <span className="text-sm">{caseStudy.metadata.deliveryTime}</span>
                </div>
                <div className="flex items-center gap-3 text-primary-foreground/60">
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="font-heading text-2xl md:text-3xl font-bold mb-6">Project Overview</h2>
              ...
              <div className="mt-6 pt-4 border-t border-border/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {caseStudy.metadata.techStack.map((tech) => (
                    <span key={tech} className="px-2 py-1 text-xs font-medium rounded bg-muted text-muted-foreground">
                      {tech}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container-wide">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">Problem Statement</h2>
            <p className="text-muted-foreground leading-relaxed text-lg">{caseStudy.problemStatement}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container-wide">
          <div className="max-w-3xl">
            <span className="text-accent text-sm font-semibold uppercase tracking-wider">Our Approach</span>
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">Solution</h2>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-wide">
          <div className="text-center mb-12">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2">Key Features</h2>
          </div>
      ...
      <section className="py-16 bg-background">
        <div className="container-wide">
          <div className="max-w-3xl">
            <span className="text-accent text-sm font-semibold uppercase tracking-wider">Design Philosophy</span>
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">{caseStudy.designApproach.title}</h2>
            <p className="text-muted-foreground leading-relaxed text-lg">{caseStudy.designApproach.description}</p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-wide">
          <div className="text-center mb-12">
            <span className="text-accent text-sm font-semibold uppercase tracking-wider">Under the Hood</span>
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2">Technical Architecture</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-card rounded-xl p-6 border border-border/50">
              <h3 className="font-heading text-lg font-semibold mb-4 text-accent">Frontend</h3>
            ...
            <div className="bg-card rounded-xl p-6 border border-border/50">
              <h3 className="font-heading text-lg font-semibold mb-4 text-accent">Backend</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-card rounded-xl p-6 border border-border/50">
              <h3 className="font-heading text-lg font-semibold mb-4 text-accent">DevOps</h3>
              <ul className="space-y-3">
      ...
      <section className="py-16 bg-background">
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <span className="text-accent text-sm font-semibold uppercase tracking-wider">Project Journey</span>
              <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2">Timeline & Execution</h2>
                    ...
                    >
                      <div className="bg-card rounded-xl p-5 border border-border/50 shadow-soft inline-block w-full">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-accent font-semibold text-sm">{phase.duration}</span>
                        </div>
                        <h3 className="font-heading font-semibold mb-2">{phase.phase}</h3>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container-wide">
          <div className="max-w-3xl">
            <span className="text-accent text-sm font-semibold uppercase tracking-wider">Quality Assurance</span>
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">Testing & QA</h2>
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          <div className="text-center mb-12">
            <span className="text-accent text-sm font-semibold uppercase tracking-wider">Measurable Outcomes</span>
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2">Results & Impact</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {caseStudy.results.map((result, index) => (
              ...
              >
                <div className="text-3xl md:text-4xl font-bold text-accent mb-2">{result.value}</div>
                <div className="font-semibold text-foreground mb-1">{result.metric}</div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container-wide">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">Key Learnings</h2>
            <ul className="space-y-4">
      ...
      {caseStudy.futureRoadmap && (
        <section className="py-16 bg-background">
          <div className="container-wide">
            <div className="max-w-3xl">
              <span className="text-accent text-sm font-semibold uppercase tracking-wider">What's Next</span>
              <h2 className="font-heading text-2xl md:text-3xl font-bold mt-2 mb-6">Future Roadmap</h2>
      ...
      <section className="section-padding bg-gradient-to-b from-primary/5 to-background">
        <div className="container-wide text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Let's Build Your Success Story</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="hero" size="lg" asChild>
                <Link href={`/case-studies/${nextCaseStudy.slug}`} className="group">
                  Next Case Study
